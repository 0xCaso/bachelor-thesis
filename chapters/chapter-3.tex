...
curve). The \code{/verifySignature} has to be revisited to enhance interoperability
...
\paragraph{zkKYC.} \acrfull{kyc} is a process that is used to verify the identity 
