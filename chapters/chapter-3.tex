...
\texttt{DIDs} and \texttt{Credentials};
\begin{center}
    \begin{tcolorbox}[
        beamer,
        width=0.6\textheight,
...
\clearpage
\subparagraph{Contracts.} In the underlying image can be seen the page screenshot.
\begin{center}
    \begin{tcolorbox}[
        beamer,
        width=0.6\textheight,
...
\vspace{1cm}
\subparagraph{Diploma.} In the underlying image can be seen the page screenshot.
\begin{center}
    \begin{tcolorbox}[
        beamer,
        width=0.6\textheight,
...
\vspace{1cm}
\subparagraph{EBSI.} In the underlying image can be seen the page screenshot.
\begin{center}
    \begin{tcolorbox}[
        beamer,
        width=0.6\textheight,
...
\clearpage
\paragraph{Backend.}
The backend is implemented as a REST API. We used it to implement the creation 
...
difficulty found was the signature creation; it took a while for us to find the real 
