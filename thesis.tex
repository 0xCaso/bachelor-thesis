...
\input{thesis-config}                     % file con le impostazioni personali
...
%**************************************************************
\frontmatter
\input{begin-end/coverpage}
\input{begin-end/colophon}
\input{begin-end/abstract}
\input{begin-end/acknowledgments}
...
%**************************************************************
\backmatter
\input{begin-end/conclusion}
\input{chapters/chapter-A}
\printglossary[type=\acronymtype, title=Acronyms, toctitle=Acronyms]
\printglossary[type=main, title=Glossary, toctitle=Glossary]
\input{begin-end/bibliography}
\end{document}
